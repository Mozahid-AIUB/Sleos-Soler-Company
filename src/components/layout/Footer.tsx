...
export function Footer({ lang, t }: { lang: Locale; t: Dictionary }) {
  const f = t.footer;
  const linkClass = "text-ink-600 transition-colors hover:text-forest-900";
  ...
  return (
    <footer className="border-t border-cream-200 bg-white text-[14.5px]">
      ...
      <div className="border-t border-cream-200">
        <div className="container-x flex flex-col gap-2 py-6 text-[13px] text-ink-400 sm:flex-row sm:items-center sm:justify-between">
          <p>
